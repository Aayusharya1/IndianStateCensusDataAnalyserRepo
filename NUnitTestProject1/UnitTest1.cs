...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\IndiaStateCensusData - IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\WrongIndiaStateCensusData.csv";
        static string delimiterIndianCensusFilePath = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\DelimiterIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFilePath = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\WrongIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFileType = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\IndiaStateCensusData.txt";
        static string indianStateCodeFilePath = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\IndiaStateCode.csv";
        static string wrongIndianStateCodeFileType = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\IndiaStateCode.txt";
        static string delimiterIndianStateCodeFilePath = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\DelimiterIndiaStateCode.csv";
        static string wrongHeaderStateCodeFilePath = @"C:\Users\Aayush Arya\source\repos\IndianStateCensusAnalyser\NUnitTestProject1\CsvFiles\WrongIndiaStateCode.csv";
